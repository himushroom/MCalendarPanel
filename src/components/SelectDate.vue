<template>
	<div class="select-date">
		<div class="check-wrap">
			<el-checkbox
				:model-value="showLunar"
				class="check"
				@input="lunarChange"
				>农历</el-checkbox
			>
			<el-checkbox
				:model-value="showFestival"
				class="check"
				@input="festivalChange"
				>节日</el-checkbox
			>
			<el-checkbox
				:model-value="beganMonday"
				class="check"
				@input="beganMondayChange"
				>从周一开始</el-checkbox
			>
			<el-checkbox
